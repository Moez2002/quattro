                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                        ...
                        <div class="card-header">
                                <h3 class="card-title">Coordonnées list</h3>
                            </div>
                            <div class="card-body">
                            <form action="{{route('listcoordonnees')}}" method="post"> 
                            @method('destroy')
                            @method('edit')
                            
                             
                             {{ method_field('get') }}
                                <a href="../fiche/fiche-coordonnees" class="btn btn-primary mb-15" type="submit" style="position:relative; left:925px; width: 150px; height: 40px;">
                                        ...
                                        @foreach($getRecord as $value) 
                                            <tr class="gradeA">
                                                ...
                                                <td class="actions">                                                                                                    
                                                    ...
                                                    <a href="{{url('/fiche/fiche-coordonnees-edit/' .$value->id )}}" class="btn btn-sm btn-icon on-default m-r-5 button-edit"
                                                    data-toggle="tooltip" data-original-title="Edit"><i class="icon-pencil" aria-hidden="true"></i></a>
                                                    @can('delete aboutusblocks') 
                                                    <a href="{{url('/fiche/fiche-coordonnees/' .$value->id)}}" class="btn btn-sm btn-icon on-default button-remove"

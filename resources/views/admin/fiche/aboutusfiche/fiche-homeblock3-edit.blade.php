            ...
            <div class="container-fluid">                 
                <div class="row clearfix">
                    <div class="col-lg-12">
                            ...
                            <form action="{{url('/fiche/aboutusfiche/fiche-homeblock3-update/' .$homeblock3->id)}}" method="post" enctype="multipart/form-data" > 
                            @method('PUT')
                            {{csrf_field()}}
                             ...
                             <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$homeblock3->title}}"  name="title" placeholder="Text..">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$homeblock3->getTranslation('title', 'fr')}}"  name="title_fr" placeholder="Text..">
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="link" value="{{$homeblock3->link}}" placeholder="Enter YouTube Link">
                                </div>
                                @if($homeblock3->image)
                                    <img src="{{asset('public/homeblock3/'.$homeblock3->image)}}" style="width:600px; height:200px;" alt=""/>
                                @endif 

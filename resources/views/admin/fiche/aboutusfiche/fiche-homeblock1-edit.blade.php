            ...
            <div class="container-fluid">                 
                <div class="row clearfix">
                    <div class="col-lg-12">
                            ...
                            <form action="{{url('/fiche/aboutusfiche/fiche-homeblock1-update/' .$homeblock1->id)}}" method="post" enctype="multipart/form-data" > 
                            @method('PUT')
                            {{csrf_field()}}
                             ...
                             <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$homeblock1->title}}"  name="title" placeholder="Text..">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">_Title (en)</label>
                                    <input type="text" class="form-control" value="{{$homeblock1->_title}}"  name="_title" placeholder="Text..">
                                </div>
                                </div>
                                <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Titre (fr)</label>
                                    <input type="text" class="form-control" value="{{$homeblock1->getTranslation('title', 'fr')}}"  name="title_fr" placeholder="Text..">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">_Titre (fr)</label>
                                    <input type="text" class="form-control" value="{{$homeblock1->getTranslation('_title', 'fr')}}"  name="_title_fr" placeholder="Text..">
                                </div>
                                </div>
                            </div>
                                @if($homeblock1->image)
                                    <img src="{{asset('public/homeblock1/'.$homeblock1->image)}}" style="width:600px; height:200px;" alt=""/>
                                @endif 

        ...
        <div id="page_top" class="section-body">
            <div class="container-fluid">
                <div class="page-header">
                    <div class="left">
                        <h1 class="page-title">Ajouter partenaires</h1>
                    </div>
                    <div class="right">
        ...
        <div class="section-body">
            <div class="container-fluid">                 
                <div class="row clearfix">
                    <div class="col-lg-12">
                            <div class="card-body">
                            <form action="{{route('insert4')}}" method="post" enctype="multipart/form-data" > 
                             {{csrf_field()}}
                             <a href="../tables/partenaire" class="btn btn-secondary mb-15" type="submit" style="position:relative; left:925px; width: 70px; height: 40px;">
                             ...
                             <div class="row">
                                ...
                                <button href="../tables/partenaire" class="btn btn-primary mb-15" type="submit" style="position:relative; left:900px; width: 100px; height: 40px;">

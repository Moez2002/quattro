        ...
        <div class="section-body">
            <div class="container-fluid">                 
                <div class="row clearfix ">
                    <div class="col-lg-12">
                        <div class="card-body">
                             <form action="{{route('insertcontactblock1')}}" method="post" enctype="multipart/form-data"> 
                            {{csrf_field()}}
                            <a href="{{asset("/new/aboutus1")}}" class="btn btn-secondary mb-15" type="submit">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="_title" placeholder="Text..">
                                    </div>
                                    </div>
                                    <div class="col-md-6">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="_title_fr" placeholder="Text..">
                                    </div>
                                    </div>
                                </div>

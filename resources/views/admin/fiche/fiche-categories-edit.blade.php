            ...
            <div class="container-fluid">                 
                <div class="row clearfix">
                    <div class="col-lg-12">
                            ...
                            <form action="{{url('/fiche/fiche-categories-update/' .$categories->id)}}" method="post"  > 
                            @method('PUT')
                            {{csrf_field()}}
                            
                             
                            
                             <a href="{{asset("/tables/categories")}}" class="btn btn-secondary mb-15"  type="submit" style="position:relative; left:925px; width: 80px; height: 40px;">
                             ...
                             <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control"   name="description"   rows="6" placeholder="Content..">{{$categories->description}}</textarea>
                                </div>
                                </div>
                                <div class="col-md-6">
                                <div class="form-group">
                                ...
                                @if($categories->image)
                                    <img src="{{asset('upload/categories/'.$categories->image)}}" style="width:600px; height:200px;" alt=""/>
                                @endif 

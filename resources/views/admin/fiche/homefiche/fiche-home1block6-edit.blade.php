            ...
            <div class="container-fluid">                 
                <div class="row clearfix">
                    <div class="col-lg-12">
                            ...
                            <form action="{{url('/fiche/homefiche/fiche-home1block6-update/' .$home1block6->id)}}" method="post" enctype="multipart/form-data" > 
                            @method('PUT')
                            {{csrf_field()}}
                             ...
                             <a href="{{asset("/new/home1")}}" class="btn btn-secondary mb-15"  type="submit" style="position:relative; left:925px; width: 80px; height: 40px;">
                                ...
                                @if($home1block6->image)
                                    <img src="{{asset('public/home/home1block6/'.$home1block6->image)}}" style="width:600px; height:200px;" alt=""/>
                                @endif 

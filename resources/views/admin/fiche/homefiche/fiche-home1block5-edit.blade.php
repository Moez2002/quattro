            ...
            <div class="container-fluid">                 
                <div class="row clearfix">
                    <div class="col-lg-12">
                            ...
                            <form action="{{url('/fiche/homefiche/fiche-home1block5-update/' .$home1block5->id)}}" method="post" enctype="multipart/form-data" > 
                            @method('PUT')
                            {{csrf_field()}}
                             ...
                             <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$home1block5->title}}"  name="title" placeholder="Text..">
                                </div>
                                </div>
                                <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Titre (fr)</label>
                                    <input type="text" class="form-control" value="{{$home1block5->getTranslation('title', 'fr')}}"  name="title_fr" placeholder="Text..">
                                </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Description (fr) <span class="form-label-small">56/100</span></label>
                                <textarea class="form-control"   name="description"   rows="6" placeholder="Content..">{{$home1block5->description}}</textarea>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Job of the professionnel of the projet</label>
                                <input type="text" class="form-control" value="{{$home1block5->proffjob}}"  name="proffjob" placeholder="Text..">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Name of the professionnel of the projet</label>
                                <input type="text" class="form-control" value="{{$home1block5->nameproff}}" name="nameproff" placeholder="Text..">
                            </div>
                            
                                @if($home1block5->proffimage)
                                    <img src="{{asset('public/home/home1block5/'.$home1block5->proffimage)}}" style="width:600px; height:200px;" alt=""/>
                                @endif 
                                ...
                                @if($home1block5->image)
                                    <img src="{{asset('public/home/home1block5/'.$home1block5->image)}}" style="width:600px; height:200px;" alt=""/>
                                @endif 
                                <div class="form-group">

            ...
            <div class="container-fluid">                 
                <div class="row clearfix">
                    <div class="col-lg-12">
                            ...
                            <form action="{{url('/fiche/homefiche/fiche-home1block7-update/' .$home1block7->id)}}" method="post" enctype="multipart/form-data" > 
                            @method('PUT')
                            {{csrf_field()}}
                             ...
                             <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$home1block7->title}}"  name="title" placeholder="Text..">
                                </div>
                                </div>
                                <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Titre (fr)</label>
                                    <input type="text" class="form-control" value="{{$home1block7->getTranslation('title', 'fr')}}"  name="title_fr" placeholder="Text..">
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{$home1block7->link}}" name="link" placeholder="Text..">
                            </div>


                                @if($home1block7->image)
                                    <img src="{{asset('public/home/home1block7/'.$home1block7->image)}}" style="width:600px; height:200px;" alt=""/>
                                @endif 
                                <div class="form-group">

        ...
        <div id="page_top" class="section-body">
            <div class="container-fluid">
                <div class="page-header">
                    <div class="left">
                        <h1 class="page-title">Ajouter block 1</h1>
                    </div>
                    <div class="right">
        ...
        <div class="section-body">
            <div class="container-fluid">                 
                <div class="row clearfix ">
                    <div class="col-lg-12">
                        <div class="card-body">
                             <form action="{{route('inserthome1block1')}}" method="post" enctype="multipart/form-data"> 
                            {{csrf_field()}}
                            <a href="{{asset("/new/home1")}}" class="btn btn-secondary mb-15" type="submit">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="namelink" placeholder="Text..">
                                    </div>
                                    </div>
                                    <div class="col-md-6">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="namelink_fr" placeholder="Text..">
                                    </div>
                                    </div>
                                </div>
                                <div class="form-group">

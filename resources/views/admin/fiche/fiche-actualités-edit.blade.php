            ...
            <div class="container-fluid">                 
                <div class="row clearfix">
                    <div class="col-lg-12">
                            ...
                            <form action="{{url('/fiche/fiche-actualités-update/' .$actualités->id)}}" method="post"  > 
                            @method('PUT')
                            {{csrf_field()}}
                             ...
                             <div class="row">
                                ...
                                @if($actualités->image)
                                    <img src="{{asset('upload/actualités/'.$actualités->image)}}" style="width:600px; height:200px;" alt=""/>
                                @endif 

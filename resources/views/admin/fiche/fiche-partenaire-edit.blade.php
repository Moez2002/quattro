        ...
        <div id="page_top" class="section-body">
            <div class="container-fluid">
                <div class="page-header">
                    <div class="left">
                        <h1 class="page-title">Edit partenaire</h1>
                    </div>
                    <div class="right">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                            ...
                            {{csrf_field()}}
                             ...
                             <a href="{{asset("/tables/partenaire")}}" class="btn btn-secondary mb-15"  type="submit" style="position:relative; left:925px; width: 80px; height: 40px;">
                             ...
                             <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$partenaire->title}}"  name="title" placeholder="Text..">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$partenaire->getTranslation('title', 'fr')}}"  name="title_fr" placeholder="Text..">
                                </div>

                                </div>
                            </div>
                                @if($partenaire->image)
                                    <img src="{{asset('public/partenaire/'.$partenaire->image)}}" style="width:600px; height:200px;" alt=""/>
                                @endif 
                                ...
                                <button href="{{asset("/tables/partenaire")}}"  class="btn btn-primary mb-15" type="submit" style="position:relative; left:900px; width: 100px; height: 40px;">
